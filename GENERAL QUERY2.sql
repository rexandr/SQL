...
--Creation ITVF. It returns a table according to setted class's value
	...
	*/
	...
	Використав би RANGE RIGHT, так як це зручніше для дат(задати кінцеву дату), тоді як RANGE LEFT більше підійде для числових діапазонів(задаємо початкову цифру).
